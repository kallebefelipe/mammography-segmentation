...
workbook = xlsxwriter.Workbook('resultadoFuzzy.xlsx')
	...
	for a in beta:
 		for b in tol:
 			for c in mode:
 				...
 				name = 'testeFuzzy/'+i+'-'+str(a)+'-'+str(b)+'-'+str(c)+'.jpg'
 				scipy.misc.imsave(name, contorno)
