...
numero_marcacao = []
sub_pasta = 5
with open('../output/evolucao/resultado_pso.csv', "w") as \
        resultado:
    ...
    for i in images:
        ...
        with open('../evolucao/sementes_pso/'+i+'.txt') as f:
            data = f.readlines()
                ...
                for c in mode:
                    ...
                    contorno = \
                        segmentation.mark_boundaries(contorno,
                                                     ...
                                                     color=(0, 1, 0))
                    name = \
                        '../output/evolucao/imagens_pso/'+i+'-'+str(a)+'-'+str(b) +\
                        '-'+str(c)+'.jpg'
    ...
    with open('../output/evolucao/result_medias_pso.csv',
              "w") as result_medias:
