...
for pasta in range(1, interation+1):
    with open('resultados_multiobjetivo/'+str(pasta)+'/resultado/resultado.csv', "w") as \
                resultado:
                    ...
                    for population_size in PopulationSize:
                        ...
                        for i in range(0, n):
                            ...
                            try:
                                ...
                                pass
                        scipy.misc.imsave('resultados_multiobjetivo/'+str(pasta) +
                                          '/images/'+path+'-'+str(cr) +
...
with open('resultados_multiobjetivo/resultado_final.csv', "w") as \
                resultado:
    output = csv.writer(resultado, quoting=csv.QUOTE_ALL)
